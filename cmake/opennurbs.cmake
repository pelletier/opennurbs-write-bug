...
FetchContent_Declare(
  ...
  GIT_TAG        a59f3b7565355d80fdddb95b80a52c740806e248
)
...
set(ON_FREETYPE_SRC
	freetype263/src/autofit/autofit.c
...
list(TRANSFORM ON_SRC PREPEND ${opennurbs_SOURCE_DIR}/)
list(TRANSFORM ON_INC PREPEND ${opennurbs_SOURCE_DIR}/)
list(TRANSFORM ON_FREETYPE_SRC PREPEND ${opennurbs_SOURCE_DIR}/)
list(TRANSFORM ON_ZLIB_SRC PREPEND ${opennurbs_SOURCE_DIR}/)

add_library(opennurbs SHARED ${ON_SRC} ${ON_ZLIB_SRC})
target_compile_definitions(opennurbs PRIVATE ON_COMPILING_OPENNURBS MY_ZCALLOC Z_PREFIX)
if(MSVC)
	target_compile_definitions(opennurbs PRIVATE UNICODE _UNICODE)
...
set(opennurbs_INCLUDE_DIRS ${opennurbs_BINARY_DIR}/include/)
file(COPY ${ON_INC} DESTINATION ${opennurbs_INCLUDE_DIRS}/opennurbs/)

set(opennurbs_LIBS_DIR ${opennurbs_BINARY_DIR}/libs/)
target_compile_definitions(opennurbs PUBLIC OPENNURBS_INPUT_LIBS_DIR=${opennurbs_LIBS_DIR})
